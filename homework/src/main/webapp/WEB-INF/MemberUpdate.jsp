		...
		<div class="col-lg-6">
			<div class="jumbotron" style="padding-top: 20px; margin-top: 20px;">
				<form method="post" action="">
					...
					<div class="form-group">
						<input type="text" class="form-control" name="filename" placeholder="파일명">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" name="realfilename" placeholder="실제파일명">
					</div>
					<div class="form-group">
						<input type="submit" class="btn btn-info form-control" value="수정"/>
					</div>
					<div class="form-group">
